...
import { Shuffle, ArrowLeft, Users, Settings, Crown, Mail, Trash2, UserPlus, TrendingUp, UserX, UserCheck } from 'lucide-react';
...
const AdminView = ({
  ...
  setView,
  loading,
  toggleUserParticipation // NOUVEAU
}) => {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8 animate-fade-in">
      ...
      <div className="bg-gradient-to-br from-dark-800/90 to-dark-900/90 backdrop-blur-xl rounded-2xl shadow-2xl p-6 mb-6 border border-white/10">
        ...
        {/* NOUVEAU: Stats des participants */}
      ...
      {/* Gestion des participants AMÉLIORÉE */}
      <div className="bg-gradient-to-br from-dark-800/90 to-dark-900/90 backdrop-blur-xl rounded-2xl shadow-2xl p-6 mb-6 border border-white/10">
        ...
        {userForm.showForm && (
          <div className="mb-6 p-5 bg-gradient-to-br from-emerald-900/20 via-dark-800/50 to-dark-900/50 backdrop-blur-sm border border-emerald-500/20 rounded-xl">
            ...
            <div className="space-y-3">
              ...
              {/* NOUVEAU: Checkbox pour participer au tirage */}
        ...
        {/* Deux sections : Participants au tirage et Hors-tirage */}
        <div className="space-y-6">
          {/* Section Participants au tirage */}
