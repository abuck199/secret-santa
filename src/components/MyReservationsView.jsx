      ...
      <div className="bg-gradient-to-br from-dark-800/90 to-dark-900/90 backdrop-blur-xl rounded-2xl shadow-2xl p-6 border border-white/10">
        ...
        {reservations.length === 0 ? (
          ...
          <div>
            ...
            {/* Réservations groupées par personne - VERSION COMPACTE */}
              ...
              {(() => {
                ...
                return Object.values(grouped).map((group, idx) => (
                  ...
                  >
                    ...
                    {/* Liste des articles - VERSION COMPACTE */}
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              {item.link && (
                                <a
                                  ...
                                  className="text-emerald-400 hover:text-emerald-300 text-xs flex items-center gap-1 font-medium transition-colors group/link"
                                >
                                  <Mail className="w-3 h-3 group-hover/link:translate-x-0.5 transition-transform" />
                                  Voir le produit
                                </a>
                              )}
                            </div>
